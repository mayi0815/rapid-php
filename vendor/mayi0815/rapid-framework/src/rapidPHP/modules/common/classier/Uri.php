...
class Uri
{
     ...
     * 
     * the function is designed to parse URL information, support Chinese characters, and serve as a complete replacement for PHP's built-in parse_url
     * - parse_url('https://mayi0815:dd@www.baidu.com:80/1?a=1')
